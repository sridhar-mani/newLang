...
export class WebGPURuntime extends Shader3DRuntime {
    ...
    setupMouseTracking(canvas) {
        const updateMouse = (e, isClick = false) => {
    ...
    updateBuiltinUniforms() {
        if (!this.builtinUniformBuffer || !this.canvas)
            return;
    ...
    beginRenderPass(config = {}) {
        ...
        const { clearColor = { r: 0, g: 0, b: 0, a: 1 }, loadOp = 'clear', storeOp = 'store' } = config;
     ...
     */
    renderFullscreenQuad(pipelineName, bindGroup, config) {
